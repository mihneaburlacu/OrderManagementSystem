...
/**
 * <p>Clasa pentru realizarea interfetei grafice, care contine fereastra pentru tabela Student (Client)</p>
...
public class StudentView extends JFrame {
    ...
    /**
     * Constructor pentru clasa care creeaza fereastra.
     */
    public StudentView() {
        ...
        studentTable.setFont(new Font("Times New Roman", Font.PLAIN, 13));
        studentTable.setBounds(10, 10, 550, 220);
        ...
        idRemoveTextField = new JLabel("(Insert only the ID for the student)");
        ...
        findByIntroduceLabel = new JLabel("(Insert the id, name or age for the student)");
        ...
        findByComboBox.setModel(new DefaultComboBoxModel(new String[] {"ID", "Name", "Age"}));
        ...
        studentLable = new JLabel("Student Table");
        studentLable.setFont(new Font("Times New Roman", Font.BOLD, 18));
        studentLable.setBounds(600, 75, 130, 13);
        contentPane.add(studentLable);
    ...
    public String getUpdateTableAddressText() {
        return updateTable.getModel().getValueAt(0, 2).toString();
    }

    public int getUpdateTableAge() {
        return Integer.parseInt(updateTable.getModel().getValueAt(0, 3).toString());
    }

    public String getUpdateTableEmailText() {
        return updateTable.getModel().getValueAt(0, 4).toString();
    }
    ...
    public String getInsertTableAddressText() {
        return insertTable.getModel().getValueAt(0, 2).toString();
    }

    public int getInsertTableAge() {
        return Integer.parseInt(insertTable.getModel().getValueAt(0, 3).toString());
    }

    public String getInsertTableEmailText() {
        return insertTable.getModel().getValueAt(0, 4).toString();
    }
    ...
    public void setStudentTableText(Object t, int row, int col) {
        studentTable.getModel().setValueAt(t, row, col);
    }
